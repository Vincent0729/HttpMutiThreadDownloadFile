...
public class LogThread implements Callable<Boolean> {
    ...
    public Boolean call() throws Exception {
        ...
        while (DOWNLOAD_FINISH_THREAD.get() != DownloadMainThread.DOWNLOAD_THREAD_NUM) {
            ...
            String speedLog = String.format("> 已下载 %smb/%smb,速度 %skb/s,剩餘时间 %ss\n", currentFileSize, httpFileSize, speed, surplusTime);
            System.out.print("\r");
